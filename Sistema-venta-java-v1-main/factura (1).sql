...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-05-2023 a las 07:29:21
...
(2, '87654321', 'Jose Merma', '988776655', 'Urb. La Alameda'),
(3, '98876756', 'Lorien', '988762821', 'Urb. manzanitos'),
(4, '72871632', 'Marco', '987890872', 'Calle las peras'),
(5, '78675623', 'Toshiro', '987656283', 'Urb. los ciclos'),
(6, '76875621', 'Dario', '988765729', 'Calle las Petunias');
...
(3, '0001', 'Paracetamol', 3, 18, 1.60),
(4, '0002', 'Cetirizina', 3, 20, 1.50),
(5, '0003', 'Clonazepam', 2, 10, 27.00),
(6, '0004', 'Multibioticos', 2, 40, 2.80),
(7, '0005', 'Aliviax', 3, 15, 3.80),
(8, '0006', 'Pañitos Humedos', 4, 10, 5.00),
(9, '0007', 'Pañales BabySec', 2, 10, 69.90);
...
(2, '20202020', 'PeruFarma', '262626', 'Lima'),
(3, '30303030', 'Quiminet', '363636', 'Mexico'),
(4, '40404040', 'Cruzfarma', '464646', 'Trujillo');
...
INSERT INTO `usuarios` (`id`, `nombre`, `correo`, `pass`, `rol`, `Sede`) VALUES
(1, 'Nadia', 'nadia@gmail.com', 'admin', 'Administrador', 'Vallecito'),
(2, 'Ale', 'ale@gmail.com', 'admin', 'Administrador', 'Ormeño'),
(3, 'Andre', 'andre@gmail.com', 'admin', 'Administrador', 'Ormeño');
